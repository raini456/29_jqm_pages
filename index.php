    ...
    <body>
        ...
        <div data-role="page" id="page_home">
            ...
            <div data-role="content">
                <a class="ui-btn ui-btn-icon-right ui-icon-carat-r" href="#page_photo" data-transition="slide">PHOTO</a>
            </div>
        ...
        <div data-role="page" id="page_photo">
            ...
            <div data-role="content">
                <a class="ui-btn ui-btn-icon-left ui-icon-carat-l" href="#page_home" data-transition="slide" data-direction="reverse">HOME</a>
            </div>
            <div data-role="footer" data-position="fixed">
                <h5>&copy; 2018</h5>
            </div>
